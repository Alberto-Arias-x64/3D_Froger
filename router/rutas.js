...
router.get('/carrito/:id',modelo.busqueda_producto)
router.get('/lista/:categoria',modelo.busqueda_categoria)
router.get('/categorias',modelo.categorias)
router.post('/carrito',modelo.carrito_post)
router.post('/categoria',modelo.busqueda_categoria_post)
