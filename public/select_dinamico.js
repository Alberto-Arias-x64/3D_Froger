...
departamento.addEventListener("change",cambio)
...
{display: "MEDELLÍN", value: "MEDELLÍN" },
    ...
    {display: "SANTA FÉ DE ", value: "SANTA FÉ DE " },
...
const san_andrés_y_providencia=[
    {display: "SAN ANDRÉS", value: "SAN ANDRÉS" },
    {display: "PROVIDENCIA", value: "PROVIDENCIA" }
]
const amazonas=[
...
function cambio() {
    ...
    switch (dep) {
        case "Amazonas":
            imprimir_ciudades(amazonas)
            break;

        case "Antioquia":
            imprimir_ciudades(antioquía)
            break;

        case "Arauca":
            imprimir_ciudades(arauca)
            break;

        case "Atlántico":
            imprimir_ciudades(atlántico)
            break;

        case "Bolívar":
            imprimir_ciudades(bolívar)
            break;

        case "Boyacá":
            imprimir_ciudades(boyacá)
            break;

        case "Caldas":
            imprimir_ciudades(caldas)
            break;

        case "Caquetá":
            imprimir_ciudades(caquetá)
            break;

        case "Casanare":
            imprimir_ciudades(casanare)
            break;

        case "Cauca":
            imprimir_ciudades(cauca)
            break;

        case "Cesar":
            imprimir_ciudades(cesar)
            break;

        case "Chocó":
            imprimir_ciudades(chocó)
            break;

        case "Córdoba":
            imprimir_ciudades(córdoba)
            break;

        case "Cundinamarca":
            imprimir_ciudades(cundinamarca)
            break;

        case "Guainía":
            imprimir_ciudades(guainía)
            break;

        case "Guaviare":
            imprimir_ciudades(guaviare)
            break;

        case "Huila":
            imprimir_ciudades(huila)
            break;

        case "La Guajira":
            imprimir_ciudades(la_guajira)
            break;

        case "Magdalena":
            imprimir_ciudades(magdalena)
            break;

        case "Meta":
            imprimir_ciudades(meta)
            break;

        case "Nariño":
            imprimir_ciudades(nariño)
            break;

        case "Norte de Santander":
            imprimir_ciudades(norte_de_santander)
            break;

        case "Putumayo":
            imprimir_ciudades(putumayo)
            break;

        case "Quindío":
            imprimir_ciudades(quindio)
            break;

        case "Risaralda":
            imprimir_ciudades(risaralda)
            break;

        case "San Andrés y Providencia":
            imprimir_ciudades(san_andrés_y_providencia)
            break;

        case "Santander":
            imprimir_ciudades(santander)
            break;

        case "Sucre":
            imprimir_ciudades(sucre)
            break;

        case "Tolima":
            imprimir_ciudades(tolima)
            break;

        case "Valle del Cauca":
            imprimir_ciudades(valle_del_cauca)
            break;

        case "Vaupés":
            imprimir_ciudades(vaupés)
            break;

        case "Vichada":
            imprimir_ciudades(vichada)
            break;        
...
function imprimir_ciudades(array_cuidades) {
    ciudad.innerHTML = ""
    array_cuidades.forEach(element => {
        ciudad.innerHTML = ciudad.innerHTML + `<option value="${element.display.toLowerCase().replace(/^\w/, (c) => c.toUpperCase())}">${element.value.toLowerCase().replace(/^\w/, (c) => c.toUpperCase())}</option>`
    });
} 